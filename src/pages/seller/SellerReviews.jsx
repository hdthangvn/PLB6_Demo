...
const SellerReviews = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Điện thoại đẹp, pin tốt. Chỉ có điều giá hơi cao.',
      date: '2024-01-14',
      images: []
    },
    {
      ...
      rating: 5,
      comment: 'Tuyệt vời! Hiệu năng mạnh, thiết kế đẹp. Khuyến nghị mua.',
      date: '2024-01-13',
    ...
    },
    {
      ...
      rating: 3,
      comment: 'Sản phẩm ổn nhưng camera chưa được như mong đợi.',
      date: '2024-01-12',
      images: []
    },
    {
      ...
      <div className="space-y-6">
        ...
        <div className="mb-8">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl opacity-5"></div>
