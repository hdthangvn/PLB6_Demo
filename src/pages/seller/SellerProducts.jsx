...
const SellerProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      // Mock data dựa trên BE logic - C2C seller products
      const mockProducts = [
        {
          id: 1,
          name: 'iPhone 14 Pro',
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white rounded-lg transition-colors font-medium disabled:cursor-not-allowed"
              >
